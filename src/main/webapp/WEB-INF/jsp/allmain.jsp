...
<div class="layui-layout layui-layout-admin">
    ...
    <input type="hidden" name="photo_path" id="photo_path" value="${hotel_user_photo}" />
    <!-- 顶部 -->
    <div class="layui-header header">
        <div class="layui-main">
            <a href="#" class="logo">酒店预约管理系统</a>
            <!-- 显示/隐藏菜单 -->
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <!--<a class="img" title="我的头像" ><img src="" id="user_photo" class="userAvatar"></a>-->

            <a class="img" > <img src="" id="user_photo" > </a>

            <p>你好！<span class="userName">${admin.nickname } ${hotel_user.realname }</span>, 欢迎登录</p>
        </div>
